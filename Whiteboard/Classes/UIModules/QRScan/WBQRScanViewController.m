...
@interface WBQRScanViewController () <AVCaptureMetadataOutputObjectsDelegate, CAAnimationDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
{
...
@implementation WBQRScanViewController
...
- (void)initBaseUI
{
    ...
    _torchBtn.frame = CGRectMake(Width/2-15, orginY+40, 60, 60);
